...
sankeyNetwork(Links = dat, Nodes = nodes, Source = "source",
              ...
              fontSize = 11, nodeWidth = 40, LinkGroup = 'to', nodeShadow = TRUE,
              colourScale = colorJS, showNodeValues = TRUE, dragY = TRUE,dragX = TRUE,
              numberFormat = JS('d3.format(".1f")'),fontFamily = "Calibri", units = "%", 
               iterations = 0)
